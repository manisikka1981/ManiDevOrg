...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>ManiHelloWorld</apexClass>
    ...
    <layoutAssignments>
        <layout>Account-Account Layout</layout>
        <recordType>Account.ManiAccountRecordType</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Account-Account Layout</layout>
        <recordType>Account.SikkaAccountRecordType</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Lead-ManiLeadLayout</layout>
        <recordType>Lead.ManiLeadRecord</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Lead-ManiLeadLayout</layout>
        <recordType>Lead.ManiLeadRecord2</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Opportunity-Opportunity Layout</layout>
        <recordType>Opportunity.ManiOpportunity</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Opportunity-Opportunity Layout</layout>
        <recordType>Opportunity.SikkaOpportunity</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>SampleVFSampleVFPagePage</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
